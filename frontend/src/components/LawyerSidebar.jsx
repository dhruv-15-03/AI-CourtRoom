...
export default function LawyerSidebar({ mode, setMode }) {
  ...
  const menuItems = [
    { path: "/lawyer/dashboard", label: "Dashboard", icon: <HomeIcon /> },
    { path: "/lawyer/case-requests", label: "Case Requests", icon: <ListAltIcon /> },
    { path: "/lawyer/cases", label: "My Cases", icon: <HistoryIcon /> },
    { path: "/lawyer/profile", label: "My Profile", icon: <AccountCircleIcon /> },
    { path: "/lawyer/chats", label: "Chats", icon: <ChatIcon /> },
  ]
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <BalanceIcon sx={{ fontSize: 32, color: "#1e3a8a" }} />
        </Box>
        <Typography
          variant="h4"
          sx={{
